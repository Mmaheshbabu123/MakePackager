...
class ModuleGenerator extends Generator
{
    ...
    public function generateResources()
    {
        ...
        if (GenerateConfigReader::read('provider')->generate() === true) {
            ...
            $this->console->call('package:route-provider', [
                'module' => $this->getName(),
            ]);
        }
        ...
        if (GenerateConfigReader::read('abstractcontroller')->generate() === true) {
            $options = $this->type=='api'?['--api'=>true]:[];
            $this->console->call('package:make-abstractcontroller', [
